...
execute store result storage eden:temp mob_scaling.min float 1 run data get storage eden:gamerule mob_scaling.enlarge.min 100
execute store result storage eden:temp mob_scaling.max float 1 run data get storage eden:gamerule mob_scaling.enlarge.max 100
